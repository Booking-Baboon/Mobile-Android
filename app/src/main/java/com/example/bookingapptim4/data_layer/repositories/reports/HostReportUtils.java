...
import com.example.bookingapptim4.data_layer.repositories.reservations.ReservationService;
...
public class HostReportUtils {
    ...
    public static HostReportService hostReportService = retrofit.create(HostReportService.class);
}
